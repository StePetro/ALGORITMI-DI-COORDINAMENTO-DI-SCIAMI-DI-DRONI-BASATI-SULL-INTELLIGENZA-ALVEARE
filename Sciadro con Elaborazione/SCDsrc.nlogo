__includes [
  ...
  "include/recruitment_procedures.nls" ;; File sorgente contenente le procedure per il reclutamento di droni.
...
to go
  ...
  if (percentageTgtsFound = 0 and showstat < 1 )[
    saveFrame
    set showstat showstat + 1
  ]

  if (percentageTgtsFound > 25 and showstat < 2)[
    saveFrame
    set showstat showstat + 1
  ]

  if (percentageTgtsFound > 50 and showstat < 3)[
    saveFrame
    set showstat showstat + 1
  ]

  if (percentageTgtsFound > 75 and showstat < 4)[
    saveFrame
    set showstat showstat + 1
  ]

  if (percentageTgtsFound > 95 and showstat < 5)[
    saveFrame
    set showstat showstat + 1
  ]

  if (percentageTargetsExecuted > 95 and showstat < 6)[
    saveFrame
    set showstat showstat + 1
    stop
  ]
...
to saveFrame
  ...
  let tmp (word "./images/" selectScenario "_" ticks "_" date "_" time ".png")
  export-view tmp
end
...
"" ""
PENS
"found" 1.0 0 -4079321 true "" "plotxy ticks percentageTgtsFound"
"executed" 1.0 0 -13345367 true "" "plotxy ticks percentageTargetsExecuted"
